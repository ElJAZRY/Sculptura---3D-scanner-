...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_KinectPreview_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_KinectPreview_t qt_meta_stringdata_KinectPreview = {
    {
...
static const uint qt_meta_data_KinectPreview[] = {
...
void KinectPreview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KinectPreview *_t = static_cast<KinectPreview *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject *KinectPreview::metaObject() const
{
...
int KinectPreview::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
