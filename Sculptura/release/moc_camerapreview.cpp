...
void CameraPreview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraPreview::frameReady)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraPreview::depthAndColorsReady)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CameraPreview::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CameraPreview.data,
      qt_meta_data_CameraPreview,  qt_static_metacall, nullptr, nullptr}
};
